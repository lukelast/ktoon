...
/**
 * Test27: Keys with dots as literals (§7.3, §8, §13.4) Tests that dotted keys are treated as
...
data class DottedKeysData(
    ...
    @SerialName("version.1.0") val version: String,
    @SerialName("a.b.c") val abc: String,
    @SerialName("config.setting.value") val configSetting: String,
    @SerialName("user.profile.email") val userEmail: String,

    // Mix with regular keys
    val normalKey: String,
    @SerialName("data.items") val dataItems: List<Int>,
)
