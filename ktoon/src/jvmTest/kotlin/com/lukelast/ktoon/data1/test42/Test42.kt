 ...
 * line with the key omitted: `[N<delim?>]: v1,v2,…` (test04 covers the root *tabular* form; this
 * covers the root *inline* form). Quoting is delimiter-aware and numeric-lookalike aware (§7.2):
