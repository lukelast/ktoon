...
/**
 * Test24: Very small floats and precision edge cases (§2) Tests canonical decimal form for small
 * and subnormal values Expected: Trailing zeros stripped (1.5000 → 1.5), canonical form maintained
 */
